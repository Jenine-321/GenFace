...
- The GenFace dataset is available for non-commercial research purposes only.
- All images of the GenFace dataset are obtained from publicly available datasets, which are not property of our institutions. Our institutions are not responsible for the content nor the meaning of these images.
